...
graph TB
    ...
    style G fill:#ba68c8,stroke:#7b1fa2
    style H fill:#ba68c8,stroke:#7b1fa2
    style I1 fill:#ce93d8,stroke:#7b1fa2
    style I2 fill:#ce93d8,stroke:#7b1fa2
    style I3 fill:#ce93d8,stroke:#7b1fa2
    style I4 fill:#ce93d8,stroke:#7b1fa2
    style J fill:#a5d6a7,stroke:#388e3c
    style K fill:#66bb6a,stroke:#2e7d32
    style L fill:#ba68c8,stroke:#7b1fa2
    style M fill:#66bb6a,stroke:#2e7d32
```
...
graph LR
    ...
    style E1 fill:#ffcc80,stroke:#f57c00
    style E2 fill:#ffab91,stroke:#e64a19
    style F fill:#a5d6a7,stroke:#388e3c
    style G fill:#81c784,stroke:#2e7d32
    style H fill:#66bb6a,stroke:#2e7d32
...
# Logger 초기화
logger = Logger(experiment_name="ui_app")
...
**사용 방법**:
1. Logger 인스턴스 생성
   - experiment_name 형식: `ui_app`, `ui_test`
   - 예: `logger = Logger(experiment_name="ui_app")`
...
2. **02_프로젝트_구조.md** - 폴더 구조 (ui/)
3. **05_로깅_시스템.md** ⭐ - Logger 사용법
4. **06_실험_추적_관리.md** ⭐ - 실험 폴더 구조
5. **14_LLM_설정.md** - LLM 선택 및 에러 핸들링
6. **15_프롬프트_엔지니어링.md** - Easy/Hard 프롬프트 템플릿
7. **16_UI_설계.md** - Streamlit 구현 가이드

### 참고 문서
- **03_브랜치_전략.md** - Feature 브랜치
- **04_일정_관리.md** - 개발 일정
- **12_AI_Agent_설계.md** - Agent 연동
